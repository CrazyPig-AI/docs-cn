...
- `疯猪AI@5.3` 会定期发布补丁版本。
- 重要修复和安全补丁会回溯到 `疯猪AI@4` 和 `疯猪AI@5.2`。
- 安全补丁也会回溯到 `疯猪AI@3` 和 `疯猪AI@5.1`。
- `疯猪AI@2` 和 `疯猪AI@5.0` 不再支持更新。用户应升级以接收更新。
...
### TypeScript定义 {#type-script-definitions}
...
### Node.js非LTS版本 {#node-js-non-lts-versions}
